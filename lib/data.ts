...
export const projects: Project[] = [
    ...
    {
        title: "Distributed Trading Benchmarking Platform",
        description: "High-performance distributed benchmarking platform built to simulate, evaluate, and profile algorithmic trading strategies at scale, analyzing latency distributions, execution throughput, and resource utilization across multiple nodes.",
        tech: ["Go", "gRPC", "Docker", "Prometheus", "Grafana", "Redis", "InfluxDB"],
        github: "https://github.com/bhawuk-arora/distributed-trading-benchmarking-platform",
        demo: null,
        featured: true,
    },
    {
